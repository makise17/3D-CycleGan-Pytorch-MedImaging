...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default='./Data_folder/test/images/001P_pre.nii')
        parser.add_argument("--result", type=str, default='./Data_folder/test/images/001P_pre_result.nii', help='path to the .nii result to save')
